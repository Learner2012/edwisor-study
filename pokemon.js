...
/* 
//function  to get details about pokemon based on the name entered 
var pokemonInfo = function  (userName, pokemonDetails)
{
		var pokemonExist = false
	//looping through dataset
   for (currentPokemon in pokemonDetails.pokemon)
   {
	//Checking if pokemon name entered by user exists 
	
	if (pokemonDetails.pokemon[currentPokemon].name == userName)
	{
		pokemonExist = true
		console.log(JSON.stringify((pokemonDetails.pokemon[currentPokemon]),null,"\t"))	
	...
	{
		alert(" Pokemon entered "  +userName+ "  does not exist" )
	} 
   
}
//function  to check which all pokemon have name in their “next_evolution” field as entered
 function pokemonNameNextEvolution(pokemonName,pokemonData)
{
	var nextEvolutionExist = false
	//looping through dataset
	for (i in pokemonData.pokemon)
   { 
		for (j in pokemonData.pokemon[i].next_evolution)
			
	   { 
			//checking name in next evolution matches that passed
   ...
   if(nextEvolutionExist == false)
   {
	     alert ("No pokemon with mentioned next evolution name exist")
   }
   
	
	
}
//function  to take weakness as an input and display name of all pokemon who has that weakness
function pokemonWeakness(weakness,pokemonData)

{
	var weaknessExist = false
	//looping through dataset
	console.log('pokemon name with mentioned weakness')
	for (i in pokemonData.pokemon)
   {    
		for (j in pokemonData.pokemon[i].weaknesses)
	   { //checking using if the weakness in dataset matches with the entered weakness
    ...
    if(weaknessExist == false)
   {
	 alert ("No pokemon with mentioned weakness exist")
...
var pokemonName = window.prompt("Enter the name of the pokemon")
//function call to get details about pokemon based on the name entered 
pokemonInfo(pokemonName,pokemonData)

var pokemonName = window.prompt("Enter the next evolution name of the pokemon")
//function call to check which all pokemon have name in their “next_evolution” field
pokemonNameNextEvolution(pokemonName,pokemonData)

var weakness = window.prompt("Enter weakness")
//function call to take weakness as an input and display name of all pokemon who has that weakness
pokemonWeakness(weakness,pokemonData) */

 function pokemonInfo(pokemonData)
 {
    var findpokemon=window.prompt("enter your fvourite pokemon")
  


for(x in pokemonData)
  if ( pokemonData.pokemon[x].name==findpokemon)
  {console.log(JSON.stringify((pokemonData.pokemon[x]),null,"\t"))}
 }
